...
$User_name = $_SESSION['cur_user'];
if(isset($User_name)){
   $obj = new Student();
   $result =$obj->getRecBysession($User_name);
    ?>
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<meta charset="utf-8">
	<title>My Profile | KEY - Institute Management System</title>
		...
		<div class="box-content">
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane active" id="manage">
                    <a href="print_my_profile.php?employee_id=<?php echo $result['employee_id'];?>"
...
<fieldset>
<legend>
<i class="icon32 icon-color icon-user"></i>
Personal Profile
</legend>
<center>
...
<tbody>
    ...
    <tr>
       ...
       <a class="btn btn-info" href="edit_profile.php?employee_id=<?php echo $result['employee_id']; ?>" rel="facebox">
