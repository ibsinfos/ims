	...
	<div class="box span12">
		...
		<div class="box-content">
            ...
            <ul class="nav nav-tabs" id="myTab">
                ...
                <li class="active"><a href="#manage">Class Rooms</a></li>
                
                <li><a href="#create">Resources</a></li>
            </ul>
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane active" id="manage">   
                    ...
                    if(isset($_GET['schedule_id'])){
                       ...
                       $res = $object->getScheduleById($schedule_id);
            ...
            <label class="control-label" for="typeahead"> Schedule</label>
             <div class="controls">
                <select id="" name="room_type" >
                    ...
                    <option value="Lecture hall"><?php echo $res['course_name'];?></option>
                    <option>ajskcs</option>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select id="" name="room_type">
                    ...
                    <option value="Conferance">Conference Room</option>
                </select>
