...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<meta charset="utf-8">
	<title>Course Category | KEY - Institute Management System</title>
...
$("#course_cat").validationEngine({
    'custom_error_messages': {
// Custom Error Messages for Validation Types
'#course_category_name':{
'required': {'message': "Category Name should be given."}
        }
}
});
});
	...
	<div class="box span12">
		...
		<div class="box-content">
            ...
            <ul class="nav nav-tabs" id="myTab">
                ...
                <li class="active"><a href="#manage">View Course Category</a></li>
                
                <li><a href="#create">Add New Course Category</a></li>
            </ul>
...
<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid"><table aria-describedby="DataTables_Table_0_info" id="DataTables_Table_0" class="table table-striped table-bordered bootstrap-datatable datatable dataTable">
  <thead>
      <tr role="row">
          <th aria-label="ID: activate to sort column descending" aria-sort="ascending" style="width: 12px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting_asc">Course Category ID</th>
...
<tbody aria-relevant="all" aria-live="polite" role="alert">
   <?php
    ...
    <tr class="odd">
        <td class=><?php echo $row['course_category_id'];?></td>
        <td class=" ">
        ...
        <td class=" " >
            <a class="btn btn-success" href="view_course_cate_id.php?course_category_id=<?php echo $row['course_category_id'];?>" rel="facebox">
                <i class="icon-book icon-white"></i>  
                View Details                                         
            </a>
            
            <a class="btn btn-info" href="edit_course_category_details.php?course_category_id=<?php echo $row['course_category_id'];?>" rel="facebox">
    ...
    <?php }?>
                ...
                <div class="tab-pane" id="create">
                	<form class="form-horizontal" method="post" action="../controller/course.php" enctype="multipart/form-data" id="course_cat">
    <fieldset>
        <legend><i class="icon32 icon-square-plus"></i>Add new Course Category</legend>
        
        <div class="control-group">
            <label class="control-label" for="typeahead">Course Category Name </label>
            <div class="controls">
                <input id="course_category_name" class="span6 typeahead" name="course_category_name" data-validation-engine="validate[required]"   type="text">
            </div>
        </div>
               <div class="control-group">
        ...
        <div class="form-actions">
            <input type="hidden" name="action" value="add_course_cat"/>
