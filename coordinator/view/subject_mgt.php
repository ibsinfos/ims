...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<meta charset="utf-8">
	<title>Course Management | KEY - Institute Management System</title>
	...
	<div class="box span12">
		...
		<div class="box-content">
        	<form class="form-horizontal" method="post" action="">
                        <fieldset>
                            <legend><i class="icon32 icon-clipboard"></i>Course Management </legend>
                        </fieldset>
                        <div class="box-content">
                            <a href="course_category.php"> <img src="images/Course_type.png" class="image_thumbnail_large" width="100" height="100"/>
                    Manage Course Categories</a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="course.php">
                    <img src="images/subject.png" class="image_thumbnail_large" width="100" height="100"/>
                Manage Courses
                </a> 
            </div>
                        <center>
