...
<body>
	...
	<div class="box span12">
        ...
        <div class="box-content">
            ...
            <a indepth="true" class="well span4 top-block" href="students.php">
                <span class="icon32 icon-color icon-users"></span>
                <div>Manage Students</div>
                <div>(total 24)</div>
            </a>
            
            <a indepth="true" class="well span4 top-block" href="teachers.php">
        ...
        <div class="box-content">
            ...
            <a indepth="true" class="well span4 top-block" href="subjects.html">
