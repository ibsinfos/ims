...
if(!empty($_SESSION['cur_user'])&&($_SESSION['user_role']=='2'))
{
    require_once '../model/student.php';
     ...
     $seven_days_ago = strtotime($now_date) -(7*24*60*60);
...
<?php include 'common/receptionist_header.php';?>
	...
	<div class="box span12">
        ...
        <div class="box-content">
            ...
            <a indepth="true" class="well span4 top-block" href="all_courses.php">
                <span class="icon32 icon-color icon-book"></span>
                <div>Recent Courses</div>
                <div style="text-align: left;">
                  <br/>  <?php
                    $obj = new Student();
                    $recent_course = $obj->RecentCourses();
            ...
            <a indepth="true" class="well span4 top-block" href="all_course_teachers.php">
                ...
                $count =  mysql_num_rows($teachers);
                echo "Total No of Teachers: "." ".$count;
                ?></div>
            </a>
            <a indepth="true" class="well span4 top-block" href="new_student.php">
                <span class="icon32 icon-color icon-users"></span>
                <div>Recent Student Registrations</div>
                <div>
                    <br/><?php
                $obj = new Student();
                $recent_reg = $obj->getRecentAdmission($seven_days_ago);
                $count = mysql_num_rows($recent_reg);
                
                    echo "No of recent Registrations:".$count;
    ...
    <!--        <div class="box-content">
                <a indepth="true" class="well span4 top-block" href="marks.html">
                    <span class="icon32 icon-color icon-compose"></span>
                    <div>Exam marks/attendance</div>
                    <div>&nbsp;</div>
                </a>

                <a indepth="true" class="well span4 top-block" href="backup_restore.html">
                    <span class="icon32 icon-color icon-archive"></span>
                    <div>System backup/restore</div>
                    <div>&nbsp;</div>
                </a>
                <a indepth="true" class="well span4 top-block" href="settings.html">
