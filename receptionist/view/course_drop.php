...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta charset="utf-8">
        <title>Leave Courses | KEY - Institute Management System</title>
...
<link rel="stylesheet" type="text/css" href="css/bootstrap-spacelab.css" media="all">
    <script type="text/javascript">
        function getFollowingCourses(student){
            ...
            $.ajax({
                        ...
                        cache: false,
                        async:false,
                        data: {follwing_courses:true,student:student},
                        success: function(theResponse){
//                            alert(theResponse);
                            var course_list = $.parseJSON(theResponse);
                            $('#course_list').html('');
                            $.each(course_list, function(i, val) {
                                $('#course_list').append("<input type='checkbox' id='"+val.course_id+"' name='course[]' value='"+ val.course_id+"'/>"+val.course_name+"&nbsp;<input type='hidden' value="+val.course_id+" name='all_course[]'/>");                                
                            });
                        }
                    });
            }
                            ...
                            <div class="box span12">
                                ...
                                <div class="box-content">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab">
                                        <li class="active"><a href="#manage">Leave Course</a></li>
                                    </ul>
                    ...
                    <form class="form-horizontal" method="post" action="../controller/student.php" enctype="multipart/form-data">
                        <center>
                            <fieldset style="width: 100%;">
                                ...
                                <div class="controls">
                                    <input type="text" name="student" id="student" class="span6 typeahead" style="width: 200px;" onblur="getFollowingCourses(this.value);"/>
                                </div>
                            </div>
        <div class="control-group" style="width: 60%">
            <label class="control-label" for="typeahead">Courses </label>
            <div class="controls">
                <div id="course_list" >                      
                  </div>
            </div>
        </div>
                                <input type="hidden" name="drop_date" value="<?php echo date('Y-m-d H:i:s');?>"/>
        <div class="form-actions">
            <input type="hidden" value="leave_course" name="action"/>
        <input class="btn btn-primary" value="Leave Course" type="submit"/>
