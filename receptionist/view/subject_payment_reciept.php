...
if(!empty($_SESSION['cur_user'])&&($_SESSION['user_role']=='2'))
{
   ...
   if(isset($student_id)){
       ...
       $payments = $obj_student->getPaymentDetailsById($student_id, $course_id, $date);
       $receipt_no = $payments['recip_id'];
   }
?>
<html>
    <head>
    ...
    <table width="580" id="receipt">
        ...
        <tr>
         ...
         <tr>
          ...
          <tr>
              <td><?php echo $payments['course_category_name'];?></td>
              <td align="right">&nbsp;</td>
          </tr>
          <tr>
              <td><?php echo $payments['course_name'];?></td>
              <td align="right"><?php echo $payments['amount'].".00";?></td>
          </tr>
             <tr>
              <td><h3>Total</h3></td>
              <td align="right">---------<h4><?php echo $payments['amount'].".00";?></h4>======</td>
          </tr>  
            </table> 
             </td>
         </tr>
