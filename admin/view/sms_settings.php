...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<meta charset="utf-8">
	<title>Receptionist Calender | KEY - Institute Management System</title>
	...
	<div class="box span12">
		...
		<div class="box-content">
            ...
            <ul class="nav nav-tabs" id="myTab">
                <li class="active"><a href="#manage">SMS Settings</a></li>
            </ul>
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane active" id="manage">
                    <form class="form-horizontal" method="post" action="../controller/settings.php">
    <fieldset>
        <div class="control-group">
            <label class="control-label" for="typeahead">SMS Title: </label>
            <div class="controls">
                <input class="span6 typeahead" name="sms_title"  type="text">
               </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="typeahead">Message: </label>
            <div class="controls">
                <textarea style="height: 18px;" class="span6 autogrow" name="msg"></textarea>
            </div>
        </div>
        <div class="form-actions">
            <input type="hidden" value="createTemplate" name="action"/> 
                   <input class="btn btn-primary" value="Create SMS" type="submit" />
