...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<meta charset="utf-8">
	<title>Admin Dashboard | KEY - Institute Management System</title>
...
<body>
	...
	<!-- topbar ends -->		<div class="container-fluid">
            ...
            <div class="span2 main-menu-span">
               <?php include 'common/admin_side_nav.php';?>
            </div> <!--/span-->
			<!-- left menu ends -->                
	...
	<div class="box span12">
        ...
        <div class="box-content">
            ...
            <a indepth="true" class="well span4 top-block" href="users.php">
                <span class="icon32 icon-color icon-users"></span>
                <div>System Users</div>
                <div>
                    <br/><table style="width: 150px;">
                    <?php
                    $obj = new Users();
                    $res = $obj->getUsersByCategory();
                    while ($row = mysql_fetch_array($res)){
                        ?>
                    <tr>
                        <td align="left"><?php echo $row['user_role'];?></td><td>- <?php echo $row['users'];?></td>
                    </tr>
                    <?php
            ...
            <a indepth="true" class="well span4 top-block" href="faq.php">
                <span class="icon32 icon-color icon-compose"></span>
                <div>Pending FAQs</div>
                <div>
                    <br/>No of Questions to Answer:
                <?php 
                $res = $obj->getAllpendingFaq();
            ...
            <a indepth="true" class="well span4 top-block" href="backup_restore.html">
                ...
                <div>Last System backup</div>
                <div><br/><?php

//Give the backups folder directory
$directory = 'backups/';
