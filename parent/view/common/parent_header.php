<?php require_once '../model/parent.php';?>
...
if(isset($_SESSION['student'])){
    ...
    $object = new Parents();
    $res = $object->getAdmissionNoById($student);
    $student_no = $res['stu_admission_no'];
...
<div class="container-fluid">
    ...
    <a class="brand" href="dashboard.php"> <img alt="Charisma Logo" src="images/logo.png" > </a><p align="right"><?php echo $name;?></p>
				...
				<div class="btn-group pull-right">
					...
					<ul class="dropdown-menu">
						<li>
                        	<a href="../../index/view/change_password.php" rel="facebox">
						...
						<li class="divider"></li>
                        <li class="switch">
                            <a href="../../index/view/switch_student.php" >
                            	<i class="icon-switch icon-darkgray"></i>
                                <?php echo $student_no;?>	Switch Student</a>
                        </li>
						
                        <li class="divider"></li>
						<li>
                        	<a href="../../index/view/logout.php">
