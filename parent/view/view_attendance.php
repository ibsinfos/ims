...
//    $parent_id = $_SESSION['user_id'];
    $obj = new Parents();
//    $result = $obj->getStudentByParentId($parent_id);
...
<div class="row-fluid">
		...
		<div class="box-content">
            ...
            Course:
                ...
                <select id="course" name="course">
                    <option></option>
            <?php   
            $result = $obj->getCoursesByStudent($student_id);
            ...
            if(isset($_POST['action']) && $_POST['action']== 'view'){
                ...
                $month = $_POST['month'];
                if($mode == 'overall' ){                    
                    $overal = $obj->getAllClasSchedulesInYear($year, $course);                    
                    $count = mysql_num_rows($overal);
                    
                    $attendance_result = $obj->getAttendanceDates($student_id, $year, $course);
    ...
    <div style="width: 95%">
                <center>
            <?php 
                $overal_chart = $obj->getAllClasSchedulesByMonth($year, $course, $student_id);
                $course_details = $obj->getCoursesById($course);
            ?>
...
<?php
                       ...
                       $monthly = $obj->getschDates($course, $month);
                       $count = mysql_num_rows($monthly);
                       
                       $month_attendance = $obj->getAttendanceDatesInMonth($student_id, $month, $course);
  ...
  <thead>
      <tr>
        ...
        <tbody>
            ...
            <?php
                $month_chart = $obj->getAttendanceChartDatesInMonth($student_id,$month,$course);
