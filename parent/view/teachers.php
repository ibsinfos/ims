            ...
            <div class="span2 main-menu-span">
                <div class="nav-collapse sidebar-nav">
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li>
                            <a data-original-title="" href="http://joyonto.net/projects/schoolmanager/index.php/admin/settings" class="ajax-link" data-rel="popover" data-content="Institute settings">
...
<tbody aria-relevant="all" aria-live="polite" role="alert"><tr class="odd">
        ...
        <td class=" ">
            <a class="btn btn-success" href="http://joyonto.net/projects/schoolmanager/index.php/admin/teachers/personal_profile/1">
                <i class="icon-user icon-white"></i>  
                View Profile                                         
            </a>
            <a class="btn btn-info" href="http://joyonto.net/projects/schoolmanager/index.php/admin/teachers/edit/1">
