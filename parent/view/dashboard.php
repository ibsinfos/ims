...
<body>
	...
	<!-- topbar ends -->		<div class="container-fluid">
            ...
            <div class="span2 main-menu-span">
              <?php   include 'common/parent_side_nav.php';?> <!--/.well -->
            </div> <!--/span-->
			<!-- left menu ends -->                
    ...
    <table width="100%">
    <tr>
        <td><a href="courses.php" style="text-decoration: none;">
                <img src="images/courses.png" class="image_thumbnail_large" width="100" height="100"/>
                Courses&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </a>
</td>
        <td><a href="view_course_fees.php" style="text-decoration: none;">
                    <img src="images/payment_details.png" class="image_thumbnail_large" width="100" height="100"/>
                Payments&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </a> 
</td>
        <td><a href="marks.php" style="text-decoration: none;">
                    <img src="images/assignment_marks.png" class="image_thumbnail_large" width="100" height="100"/>
                Assignment Grades
                </a> </td>
    </tr>
</table>
        ...
        <div class="box-content">
            <table width="100%">
                <tr>
                    <td><a href="view_class_schedules.php" style="text-decoration: none;"> <img src="images/schedule.png" class="image_thumbnail_large" width="100" height="100"/>
                    Class Time Tables</a></td>
                    <td><a href="view_attendance.php" style="text-decoration: none;">
                    <img src="images/attendance1.png" class="image_thumbnail_large" width="100" height="100"/>
                Attendance
                </a> </td>
                    <td><a href="profile.php" style="text-decoration: none;"> <img src="images/profile.png" class="image_thumbnail_large" width="100" height="100"/>
                    My Profile - <?php echo $_SESSION['cur_user'];?></a></td>
                </tr>
            </table>
