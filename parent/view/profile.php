...
if(isset($parent_id)){
   $obj = new Parents();
   $result =$obj->getParentById($parent_id);
    ?>
...
<tbody>
    ...
    <tr>
        ...
        <td>
        <b><?php echo $result['occupation'];?></b>
        </td>
    </tr>
   ...
   <tr>
        <td>Email</td>
        <td>
        <b><?php echo $result['parent_email'];?></b>
        </td>
    </tr>
       ...
       <a class="btn btn-info" href="edit_profile.php?parent_id=<?php echo $result['parent_id']; ?>" rel="facebox">
