...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<meta charset="utf-8">
	<title>Class Time Tables | KEY - Institute Management System</title>
		...
		$('#sche_calendar').fullCalendar({
			...
			eventSources: [
                            ...
                            // your event source
                            {
                                ...
                                type: 'POST',
                                data: {
                                    get_calender_data: true,
                                    login_id: <?php echo $_SESSION['user_id']?>
                                },
                                error: function() {
                                    alert('there was an error while fetching events!');
                                },
                                color: '#05BF5F',   // a non-ajax option
