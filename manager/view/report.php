<?php 
//session_start() ;
//if(!empty($_SESSION['cur_user'])&&($_SESSION['user_role']=='4'))
//{    ?>
...
<div class="row-fluid">
		...
		<div class="box-content">
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane active" id="manage">
                    ...
                    <center><h3>Lecture Fee Payment Details</h3></center>
                    <br/><br/>
  ...
  <thead>
      <tr role="row"><th aria-label="Photo: activate to sort column ascending" style="width: 200px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting" width="80">Name</th><th aria-label="Name: activate to sort column ascending" style="width: 177px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Total lecture Hours</th><th aria-label="Email: activate to sort column ascending" style="width: 168px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Payable Amount</th><th aria-label="Options: activate to sort column ascending" style="width: 350px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting" width="350">Options</th></tr>
  </thead>   
  
<tbody aria-relevant="all" aria-live="polite" role="alert"><tr class="odd">
       
        <td class=" ">
                      Miss. Madhavi Upeksha  
        </td>
        <td class=" " >07:45</td>
        <td class=" ">Rs. 3,725.00</td>
        <td class=" ">
...
<tr class="odd">
        ...
        <td class=" ">
                     Miss. Gayani Pitiiyage  
        </td>
        <td class=" " >08:15</td>
        <td class=" ">Rs. 8,150.00</td>
        <td class=" ">
...
<tr class="odd">
        ...
        <td class=" ">
                      Mr. Kanishka Premarathna  
        </td>
        <td class=" " >06:00</td>
        <td class=" ">Rs. 6,000.00</td>
        <td class=" ">
