...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<meta charset="utf-8">
	<title>Manager Dashboard | KEY - Institute Management System</title>
...
<body>
	...
	<!-- topbar ends -->		<div class="container-fluid">
            ...
            <div class="span2 main-menu-span">
                <?php include 'common/manager_side_nav.php';?>
                <!--/.well -->
            </div> <!--/span-->
			<!-- left menu ends -->                
	...
	<div class="box span12">
        ...
        <div class="box-content">
            ...
            <a indepth="true" class="well span4 top-block" href="student_report.php">
                ...
                <div>
                    ...
                    echo "Total No of Students: ".$count;
                    ?>
                </div>
            </a>
            
            <a indepth="true" class="well span4 top-block" href="lecture_feedback.php">
                <span class="icon32 icon-color icon-user"></span>
                <div>Manage Teachers</div>
                <div><?php
                    $teacher = $obj->getAllTeachers();
                    $teacher_count = mysql_num_rows($teacher);
                    echo "Total No of Lecturers: ".$teacher_count;
                ?>
                </div>
            </a>
            
            <a indepth="true" class="well span4 top-block" href="income_reports.php">
                <span class="icon32 icon-color icon-compose"></span>
                <div>Income Reports</div>
                <div>&nbsp;</div>
            </a>
        </div>
        <div class="box-content">
            ...
            <a indepth="true" class="well span4 top-block" href="">
                ...
                <div>
                    <?php 
                    $classrooms = $obj->getAllClasses();
                    $class_count = mysql_num_rows($classrooms);
                    echo "Total Class Rooms : ".$class_count."<br/>";
                    $equipments = $obj->getAllResources();
                    $resource_count = mysql_num_rows($equipments);
                    echo "Total No of Eqipments : ".$resource_count;
                ?>
                </div>
            </a>
            <a indepth="true" class="well span4 top-block" href="personal_profile.php">
                ...
                <div>Profile</div>
                <div><?php echo "(".$_SESSION['cur_user'].")";?></div>
            </a>
            <a indepth="true" class="well span4 top-block" href="">
                <span class="icon32 icon-color icon-wrench"></span>
                <div>Staff Login Details</div>
                <div><?php 
                $emp_login = $obj->currentlyLoggedEmployees();
                $row = mysql_fetch_array($emp_login);
                if(mysql_num_rows($emp_login)>0){
                echo "<br/>".$row['user_name']." - ".date('H:ia',  strtotime($row['log_in_time'])); }
                else{
                    echo "<br/>"."No users Logged In Currently!";
                }?></div>
            </a>
