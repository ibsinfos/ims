...
function printDiv(divName) {
	document.body.style.textShadow = '0px 0px 0px' ;
	 var printContents = document.getElementById(divName).innerHTML+'<hr /><p style="font-size:10px;">Powered by: <a href="http://codecanyon.net/user/joyontaroy?ref=joyontaroy" target="_blank">\Ekattor school-college management system</a></p>';
...
$(document).ready(function(){
	...
	{
		//$('#bs-css').attr('href','../../template/css/bootstrap-'+theme_name+'.css');
		//$('#bs-css').attr('href','../../template/css/bootstrap-spacelab.css');
	}
