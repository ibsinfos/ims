...
$manager= $_SESSION['cur_user']; 
if(isset($manager)){
    $obj = new Manager();
    $result=$obj->getManager($manager);
    ?>
...
<tbody>
    ...
    <tr>
       ...
       <a class="btn btn-info" href="edit_personal_profile.php?employee_id=<?php echo $result['employee_id']; ?>" rel="facebox">
