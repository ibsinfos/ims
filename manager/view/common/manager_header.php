...
<div class="container-fluid">
				...
				<div class="btn-group pull-right">
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="log_top">
						<i class="icon-user_1"></i><span class="hidden-phone"> Logged in as <?php echo $_SESSION['cur_user']; ?></span>
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
                                                <li><a indepth="true" href="../../index/view/faq_results.php" target="_blank">
